    ...
    <div class="col-md-8 mx-auto">
        <div class="card bg-light mt-5">
            <div class="card-header card-text">
                <div class="row">
                    <div class="col">
                        <h2 class="card-text">Edit Policy</h2>
                    </div>
            ...
            <div class="card-body">
                <form method="post" action="<?php echo URLROOT; ?>/policy/edit/<?php echo $data['id']; ?>">
                    <div class="form-group">
                        <label for="first_name">First Name*</label>
                        <input type="text" name="first_name" id="first_name"  class="form-control form-control-lg <?php echo (!empty($data['first_name_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['first_name']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="premium" id="premium" class="form-control form-control-lg <?php echo (!empty($data['premium_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['premium']; ?>">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                <input type="submit" id="submit_button" class="btn btn-primary btn-block pull-left" value="Update Policy">
                            </div>
                        </div>
                    </div>
                </form>
